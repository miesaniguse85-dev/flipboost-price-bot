...
def get_prices():
    try:
        ...
        if r.status_code == 200:
            f = r.json().get("fields", {})
            return {
                "250g": int(f.get("price_250g", {}).get("integerValue", DEFAULT["250g"])),
                "500g": int(f.get("price_500g", {}).get("integerValue", DEFAULT["500g"])),
                "1kg":  int(f.get("price_1kg",  {}).get("integerValue", DEFAULT["1kg"])),
            }
